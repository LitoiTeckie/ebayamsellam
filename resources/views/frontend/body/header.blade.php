...
<header class="header-area header-style-1 header-height-2">
    <div class="mobile-promotion">
        <span>Rabais de, <strong>30%</strong>sur Tous les articles. <strong>Plus que</strong> 3 jours</span>
    </div>
        ...
        <div class="container">
            ...
            <li>
                ...
                <ul class="language-dropdown">
                    <li>
                        <a href="#"><img src="{{ asset('frontend/assets/imgs/theme/flag-fr.png') }}" alt="" />FrançaisEnglish</a>
                    </li>
                    <li>
             ...
             <li>Appellez-nous : <strong class="text-brand"> 674667234</strong></li>
...
<div class="header-right">
    <div class="search-style-2">
        <form action="{{ route('product.search') }}" method="post">
            ...
            <input onfocus="search_result_show()" onblur="search_result_hide()" name="search" id="search" placeholder="Rechercher..." />
        ...
        <div class="header-action-2">
            ...
            <div class="header-action-icon-2">
                <a href="{{ route('compare') }}">
                    <img class="svgInject" alt="Comparer" src="{{ asset('frontend/assets/imgs/theme/icons/icon-compare.svg')}}" />
            ...
            <div class="header-action-icon-2">
                ...
                <a href="{{ route('wishlist') }}"><span class="lable"> Achats</span></a>
            </div>
...
<div class="header-action-icon-2">
                ...
                <a href="{{ route('mycart') }}"><span class="lable">Panier</span></a>
    <div class="cart-dropdown-wrap cart-dropdown-hm2">
        ...
        <div class="shopping-cart-footer">
            ...
            <div class="shopping-cart-button">
                <a href="shop-cart.html" class="outline">Caisse</a>
                <a href="{{ route('mycart') }}">Voir le Panier</a>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="header-action-icon-2">
                                <a href="{{ route('login') }}">
                                    <img class="svgInject" alt="Utilisateur" src="{{ asset('frontend/assets/imgs/theme/icons/icon-user.svg') }}" />
                                </a>
...
<a href="{{ route('dashboard') }}"><span class="lable ml-0">Compte</span></a>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('dashboard') }}"><i class="fi fi-rs-location-alt mr-10"></i>Suivi Commande</a>
            </li>
            {{-- <li>
                <a href="{{ route('dashboard') }}"><i class="fi fi-rs-label mr-10"></i>My Voucher</a>
            </li> --}}
            <li>
                <a href="{{ route('dashboard') }}"><i class="fi fi-rs-heart mr-10"></i>Wishlist</a>
            </li>
            <li>
                <a href="{{ route('dashboard') }}"><i class="fi fi-rs-settings-sliders mr-10"></i>Paramètres</a>
            </li>
            <li>
                <a href="{{ route('user.logout') }}"><i class="fi fi-rs-sign-out mr-10"></i>Déconnexion</a>
            </li>
        </ul>
                                </div>
...
<a href="{{ route('register') }}"><span class="lable ml-0">Inscription</span></a>
...
$subcategories = App\Models\SubCategory::where('category_id',$category->id)->orderBy('subcategory_name','ASC')->get();
    ...
    @endforeach
        ...
        <li>
                <a href="{{ route('shop.page') }}">Boutique</a>
        </li>
        <li>
...
<div class="hotline d-none d-lg-flex">
    ...
    <p>{{ $setting->support_phone }}<span>Assistance 24/7</span></p>
{{-- <a href="{{ route('become.vendor') }}" class="btn w-100 hover-up"><i class="fi-rs-user mr-10"></i>Devenir Vendeur</a> --}}
...
{{-- <li class="menu-item-has-children">
    ...
    <ul class="dropdown">
        ...
        <li><a href="shop-fullwidth.html">Shop - Wide</a>
        </li>
        <li class="menu-item-has-children">
...
// $categories = App\Models\Category::orderBy('category_name','ASC')->limit(5)->get();
   ...
   @foreach($categories as $category)
                    <li class="menu-item-has-children">
                        <a href="{{ url('product/category/'.$category->id.'/'.$category->category_slug) }}">{{ $category->category_name }} </i></a>
    @php
$subcategories = App\Models\SubCategory::where('category_id',$category->id)->orderBy('subcategory_name','ASC')->get();
    @endphp
                        <ul class="dropdown">
...
@endauth
    ...
    {{-- End single mobile login/register --}}
</div>
            ...
            <div class="site-copyright">Copyright 2023 © eBoutiQ. All rights reserved.</div>
        </div>
    </div>
</div>
